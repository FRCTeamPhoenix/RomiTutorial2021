...
void RomiGyro::UpdateDebugValues(){
  frc::SmartDashboard::PutNumber("Gyro X", GetAngleX());
  frc::SmartDashboard::PutNumber("Gyro Y", GetAngleY());
  frc::SmartDashboard::PutNumber("Gyro Z", GetAngleZ());
}